...
client = InferenceClient(model="meta-llama/Llama-3.2-11B-Vision-Instruct",token="")
        ...
        if image_filename.lower().endswith(('.png', '.jpg', '.jpeg')):
            ...
            response = client.chat_completion(
                ...
                messages=[
                    ...
                    {"role": "user", "content": [
                        {"type": "text", "text": f"Classify the emotion from the image.Only output the emotion label and do not add a fullstop."},
